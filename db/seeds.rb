...
@schools.each do |school|
  ...
  address = "#{school['fields']['adresse_1']}, #{school['fields']['code_posta']} #{school['fields']['nom_commune']}"
  # retrive area
